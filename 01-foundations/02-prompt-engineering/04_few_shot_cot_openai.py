...
class PromptingClient:
    ...
    def classify_ticket_few_shot(self, ticket: str) -> str:
        ...
        return self._call(instructions, f'工单："{ticket}"\n类别：')
...
def _run_zero_shot(console: Console, client: PromptingClient) -> None:
    ...
    console.print(Panel(ZERO_SHOT_INSTRUCTIONS, title="指令", border_style="dim"))
...
def _run_few_shot(console: Console, client: PromptingClient) -> None:
    ...
    console.print(Panel(instructions, title="指令", border_style="dim"))
...
def _run_cot(console: Console, client: PromptingClient) -> None:
    ...
    console.print(Panel(COT_INSTRUCTIONS, title="指令", border_style="dim"))
    console.print(Panel(BUG_REPORT, title="用户输入", border_style="dim"))
...
def main() -> None:
    ...
    client = PromptingClient("gpt-5.5", token_tracker)
